...
## Modules
- **Launcher** (`public/index.html`) : page d’entrée vers les modules avec le cache-buster `?v=2025.12.27.1` et une URL de partage par défaut.
...
- Anti-cache : requiert le `?v=2025.12.27.1` sur les liens du launcher et les scripts (ex. `js/prompt.js?v=...`) ; à incrémenter partout quand les assets changent.
- Workers Cloudflare :
